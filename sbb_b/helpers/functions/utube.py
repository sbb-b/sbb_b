...
async def yt_search(sbb_b):
    try:
        sbb_b = urllib.parse.quote(sbb_b)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={sbb_b}"
        )
...
"""
async def yt_data(sbb_b):
    params = {"format": "json", "url": sbb_b}
