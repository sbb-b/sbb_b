...
from wand.image import Image as sbb_bimage

from .utils import _sbb_butils
...
async def sbb_b_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def sbb_b_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = sbb_bimage(filename=picture_name)
    main_image.resize(
