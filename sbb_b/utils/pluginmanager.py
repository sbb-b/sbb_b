...
from ..helpers.utils import _format, _sbb_btools, _sbb_butils, install_pip, reply_id
...
def load_module(shortname, plugin_path=None):
    if shortname.startswith("__"):
        ...
        checkplugins(path)
        name = "sbb_b.plugins.{}".format(shortname)
        ...
        mod._sbb_butils = _sbb_butils
        mod._sbb_btools = _sbb_btools
        ...
        spec.loader.exec_module(mod)
        # for imports
        sys.modules["sbb_b.plugins." + shortname] = mod
        LOGS.info("تم بنجاح تثبيت ملف " + shortname)
