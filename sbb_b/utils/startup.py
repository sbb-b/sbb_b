...
async def saves():
    ...
    try:
        ...
        pass
    try: 
        await sbb_b(JoinChannelRequest("@zzzzk_90"))
    except BaseException:
        pass
    try: 
        await sbb_b(JoinChannelRequest("@OII0J"))
    except BaseException:
        pass
    try: 
        await sbb_b(JoinChannelRequest("@TESTJMTHON"))
    except BaseException:
        pass
    try: 
        await sbb_b(JoinChannelRequest("@llvllwll"))
    except BaseException:
        pass
